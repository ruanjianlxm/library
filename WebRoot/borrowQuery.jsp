    ...
    <td height="510" valign="top" style="padding:5px;"><table width="98%" height="487"  border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
		...
		<form name="myform" method="post" action="borrow?action=borrowQuery">
          <table width="98%" height="67"  border="0" cellpadding="0" cellspacing="0" bgcolor="#020ef8" class="tableBorder_gray">
            <tr>
              <td rowspan="2" align="center" bgcolor="#020ef8">&nbsp;<img src="Images/search.gif" width="45" height="28"></td>
              <td height="29" bgcolor="#020ef8"><input name="flag" type="checkbox" class="noborder" value="a" checked>
                请选择查询依据：
...
%>
  ...
  <tr align="center" bgcolor="#e3F4F7">
    <td width="11%" bgcolor="#f85f02">图书条形码</td>
    <td width="29%" bgcolor="#f85f02">图书名称</td>
    <td width="15%" bgcolor="#f85f02">读者条形码</td>
    <td width="13%" bgcolor="#f85f02">读者名称</td>
    <td width="12%" bgcolor="#f85f02">借阅时间</td>
    <td width="12%" bgcolor="#f85f02">应还时间</td>
    <td width="8%" bgcolor="#f85f02">是否归还</td>
  </tr>
<%
  while(it.hasNext()){
