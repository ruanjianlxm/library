...
<%	int ID=bookForm.getId().intValue();
  ...
  %>
	<table width="600" height="432"  border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      <tr>
        <td width="173" align="center"><input name="form.Id" type="hidden" id="id" value="<%=ID%>">
          图&nbsp;书&nbsp;码：</td>
        <td width="427" height="39">
          <input name="form.Barcode" type="text" id="barcode" value="<%=barcode%>"></td>
      </tr>
      <tr>
        <td align="center">图书名称：</td>
        <td height="39"><input name="form.BookName" type="text" id="bookName" value="<%=bookname%>" size="60">
          * </td>
      </tr>
      <tr>
...
<%}%> 
      ...
      <tr>
        ...
        <td><input name="form.Author" type="text" id="author" value="<%=author%>"></td>
      </tr>
 
      <tr>
        <td align="center">出版社：</td>
        <td><select name="form.Isbn" class="wenbenkuang">
<%
...
<%}%> 
      ...
      <tr>
        ...
        <td><input name="form.Page" type="text" id="page" value="<%=pages%>"></td>
      </tr>
