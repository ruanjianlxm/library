  ...
  <tr>
	...
	<table height="126"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="190">
          <input name="form.Id" type="hidden" value="<%=ID%>"><input name="form.Name" type="text" readonly="yes" value="<%=name%>">        </td>
      </tr>
      <tr>
        <td height="74" align="center">拥有的权限：</td>
        <td><table width="100%" height="67" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="47%"><input name="form.Sysset" type="checkbox" class="noborder" id="sysset" value="1" <%if(sysset==1){out.println("checked");}%>>
系统设置</td>
            <td width="53%"><input name="form.Readerset" type="checkbox" class="noborder" id="readerset" value="1" <%if(readerset==1){out.println("checked");}%>>
              读者管理</td>
          </tr>
          <tr>
            <td><input name="form.Bookset" type="checkbox" class="noborder" id="bookset" value="1" <%if(bookset==1){out.println("checked");}%>>
              图书管理</td>
            <td><input name="form.Borrowback" type="checkbox" class="noborder" id="borrowback" value="1" <%if(borrowback==1){out.println("checked");}%>>
              图书借还</td>
          </tr>
          <tr>
            <td height="23"><input name="form.Sysquery" type="checkbox" class="noborder" id="sysquery" value="1" <%if(sysquery==1){out.println("checked");}%>>
              系统查询</td>
            <td>&nbsp;</td>
          </tr>
        </table>          </td>
