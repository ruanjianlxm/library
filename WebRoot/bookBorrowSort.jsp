...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td height="510" valign="top" style="padding:5px;"><table width="98%" height="487"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td height="22" valign="top" class="word_orange">当前位置：图书借阅排名 &gt;&gt;&gt;</td>
      </tr>
      <tr>
...
%>
  ...
  %>
 <table width="98%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#02f82a" bordercolordark="#F6B83B" bordercolorlight="#FFFFFF">
  <tr align="center" bgcolor="#e3F4F7">
  <td width="8%" bgcolor="#02f82a">借阅次数</td>
    <td width="11%" bgcolor="#02f82a">图书条形码</td>
    <td width="17%" bgcolor="#02f82a">图书名称</td>
    <td width="15%" bgcolor="#02f82a">图书类型</td>
    <td width="14%" bgcolor="#02f82a">出版社</td>
    <td width="11%" bgcolor="#02f82a">作者</td>
    <td colspan="2" bgcolor="#02f82a">定价(元)</td>
    </tr>
<%
  while(it.hasNext()){
