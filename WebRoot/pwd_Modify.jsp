 ...
 <table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr align="center">
    ...
    <td width="73%" align="left">
      <input name="form.Name" type="text" id="name" value="<%=chStr.toChinese(managerForm.getName())%>" readonly="yes" size="30">    </td>
    <tr>
    ...
    <tr>
      ...
      <td align="left"><input name="form.Pwd" type="password" id="pwd" size="30"></td>
    </tr>
    <tr>
