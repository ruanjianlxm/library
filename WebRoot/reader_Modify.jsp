...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td height="510" valign="top" style="padding:5px;"><table width="98%" height="487"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td height="22" valign="top" class="word_orange">当前位置：读者管理 &gt; 读者信息管理 &gt; 修改读者信息 &gt;&gt;&gt;</td>
      </tr>
      <tr>
	...
	<table width="600" height="432"  border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      <tr>
        ...
        <td width="427" height="39">
          <input name="form.Name" type="text" value="<%=name%>"> 
          *         
          <input name="form.Id" type="hidden" id="id" value="<%=ID%>"></td>
      </tr>
      <tr>
        <td width="173" align="center">性&nbsp;&nbsp;&nbsp;&nbsp;别：</td>
        <td height="35"><input name="form.Sex" type="radio" class="noborder" id="radiobutton" value="男" <%if("男".equals(sex)) out.println("checked");%>>
          <label for="radiobutton">男 </label>
          <label>
          <input name="form.Sex" type="radio" class="noborder" value="女" <%if("女".equals(sex)) out.println("checked");%>>
          女</label></td>
      </tr>
      <tr>
        <td align="center">条&nbsp;形&nbsp;码：</td>
        <td><input name="form.Barcode" type="text" id="barcode" value="<%=barcode%>" readonly="yes"></td>
      </tr>
      <tr>
...
<%}%> 
      ...
      <tr>
        ...
        <td><input name="form.Vocation" type="text" id="vocation" value="<%=vocation%>"></td>
      </tr>
      <tr>
        <td align="center">出生日期：</td>
        <td><input name="form.Birthday" type="text" id="birthday" value="<%=birthday%>"></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><input name="form.PaperNO" type="text" id="paperNO" value="<%=paperNO%>"> 
          * </td>
      </tr>
      <tr>
        <td align="center">电&nbsp;&nbsp;&nbsp;&nbsp;话：</td>
        <td><input name="form.Tel" type="text" id="tel" value="<%=tel%>"></td>
      </tr>
      <tr>
        <td align="center">Email：</td>
        <td><input name="form.Email" type="text" id="email" value="<%=email%>" size="50">
          <input name="form.Operator" type="hidden" id="operator" value="<%=operator%>"></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><textarea name="form.Remark" cols="50" rows="5" class="wenbenkuang" id="remark"><%=remark%></textarea></td>
      </tr>
      <tr>
        <td align="center">&nbsp;</td>
