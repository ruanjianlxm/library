...
<td width="18%" align="right">
  ...
  <table width="91%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#fa01da" bordercolordark="#F6B83B" bordercolorlight="#FFFFFF">
  <tr align="center" bgcolor="#e3F4F7">
    <td width="35%" bgcolor="#fa01da">图书类型名称</td>
    <td width="35%" bgcolor="#fa01da">可借天数</td>
    <td width="16%" bgcolor="#fa01da">修改</td>
    <td width="14%" bgcolor="#fa01da">删除</td>
  </tr>
<%
  while(it.hasNext()){
  ...
  <tr>
    ...
    <td align="center"><a href="#" onClick="window.open('bookType?action=bookTypeModifyQuery&form.Id=<%=ID%>','','width=292,height=175')">修改</a></td>
    <td align="center"><a href="bookType?action=bookTypeDel&form.Id=<%=ID%>">删除</a></td>
  </tr>
<%
  }
}
