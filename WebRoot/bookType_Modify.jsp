...
<body>
<%
BookTypeForm form = new BookTypeForm();
...
<table width="292" height="175" border="0" cellpadding="0" cellspacing="0" background="Images/subBG.jpg">
 ...
 <input name="form.Id" type="hidden" size="50" value="<%=bookTypeForm.getId()%>"> 
  <table width="100%" height="111" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="29%" align="center">类型名称：      </td>
    <td width="71%"><input name="form.TypeName" type="text" size="30" value="<%=bookTypeForm.getTypeName()%>">
      </td>
  </tr>
  <tr>
    <td align="center">可借天数：</td>
    <td><input name="form.Days" type="text" size="25" value="<%=bookTypeForm.getDays()%>">
      (天)</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
