...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td height="510" valign="top" style="padding:5px;"><table width="98%" height="487"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td height="22" valign="top" class="word_orange">当前位置：读者管理 &gt; 读者信息管理 &gt;&gt;&gt;</td>
      </tr>
      <tr>
...
<td width="13%">
  ...
  <table width="95%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#c0ffff" bordercolordark="#F6B83B" bordercolorlight="#FFFFFF">
  <tr align="center" bgcolor="#e3F4F7">
    <td width="13%" bgcolor="red">条形码</td>  
    <td width="10%" bgcolor="red">姓名</td>
    <td width="8%" bgcolor="red">读者类型</td>
    <td width="12%" bgcolor="red">证件类型</td>
    <td width="20%" bgcolor="red">证件号码</td>
    <td width="12%" bgcolor="red">电话</td>
    <td width="15%" bgcolor="red">Email</td>
    <td width="5%" bgcolor="red">修改</td>
    <td width="5%" bgcolor="red">删除</td>
  </tr>
<%
  while(it.hasNext()){
