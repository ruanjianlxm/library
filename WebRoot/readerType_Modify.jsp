...
%>
<table width="292" height="175" border="0" cellpadding="0" cellspacing="0" background="Images/subBG.jpg" align="center">
  <tr>
 ...
 <input name="form.Id" type="hidden" size="50" value="<%=readerTypeForm.getId()%>"> 
  <table width="100%" height="111" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="28%" align="center">类型名称：      </td>
    <td width="72%"><input name="form.Name" type="text" size="28" value="<%=readerTypeForm.getName()%>">
      </td>
  </tr>
  <tr>
    <td align="center">可借数量：</td>
    <td><input name="form.Number" type="text" size="25" value="<%=readerTypeForm.getNumber()%>">
      (本)</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
