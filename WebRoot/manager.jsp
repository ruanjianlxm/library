...
<td width="16%">
  ...
  <tr align="center" bgcolor="#e3F4F7">
    <td width="26%" bgcolor="#c0ffff">管理员名字</td>
    <td width="12%" bgcolor="c0ffff">系统设置</td>
    <td width="12%" bgcolor="blue">管理成员</td>
    <td width="12%" bgcolor="blue">图书管理</td>
    <td width="11%" bgcolor="c0ffff">借还处理</td>
    <td width="10%" bgcolor="c0ffff">查询记录</td>
    <td width="9%" bgcolor="red">权限设置</td>
    <td width="8%" bgcolor="yellow">删除</td>
  </tr>
<%
  while(it.hasNext()){
  ...
  <tr>
    ...
    <td align="center"><%if(!name.equals("tsoft")){ %><a href="#" onClick="window.open('manager?action=managerModifyQuery&id=<%=ID%>','','width=292,height=175')">权限设置</a><%}else{%>&nbsp;<%}%></td>
    <td align="center">
	<%if(!name.equals("tsoft")){ %><a href="manager?action=managerDel&id=<%=ID%>">删除</a><%}else{%>&nbsp;<%}%></td>
  </tr>
<%
  }
}
