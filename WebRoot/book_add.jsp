...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
	...
	<table width="600" height="432"  border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      <tr>
        <td width="173" align="center">图&nbsp;书&nbsp;号：</td>
        <td width="427" height="39">
          <input name="form.Barcode" type="text" id="barcode">
          *</td>
      </tr>
      <tr>
        <td align="center">图书名称：</td>
        <td height="39"><input name="form.BookName" type="text" id="bookName" size="50">
          * </td>
      </tr>
      <tr>
...
<%}%> 
      ...
      <tr>
        ...
        <td><input name="form.Author" type="text" id="author" size="40"></td>
      </tr>
      <tr>
...
<%}%> 
      ...
      <tr>
        ...
        <td><input name="form.Page" type="text" id="page"></td>
      </tr>
      <tr>
