...
%>
  ...
  <tr align="center">
    ...
    <td width="80%" align="left">
      <input name="form.Libraryname" type="text" id="libraryname" value="<%=libraryname%>" size="30">
    
    </td>
    <tr>
    <td align="left" style="padding:5px;">馆长：</td>
    <td align="left"><input name="form.Curator" type="text" id="curator" size="30" value="<%=curator%>" ></td>
    </tr>
    <tr>
      <td align="left" style="padding:5px;">联系电话：</td>
      <td align="left"><input name="form.Tel" type="text" id="tel" size="30" value="<%=tel%>"></td>
    </tr>
    <tr>
      <td align="left" style="padding:5px;">联系地址：</td>
      <td align="left"><input name="form.Address" type="text" id="address" size="30" value="<%=address%>"></td>
    </tr>
    <tr>
      <td align="left" style="padding:5px;">联系邮箱：</td>
      <td align="left"><input name="form.Email" type="text" id="email" size="30" value="<%=email%>"></td>
    </tr>
    <tr>
      <td align="left" style="padding:5px;">图书馆网址：</td>
      <td align="left"><input name="form.Url" type="text" id="url" size="30" value="<%=url%>"></td>
    </tr>
    <tr>
      <td align="left" style="padding:5px;">建立时间：</td>
      <td align="left"><input name="form.CreateDate" type="text" id="createDate" size="30" value="<%=createTime%>">
      (日期格式：2012-12-22)</td>
    </tr>
    <tr>
      <td height="84" align="left" style="padding:5px;">图书馆简介：</td>
      <td align="left"><textarea name="form.Introduce" cols="50" rows="5" class="wenbenkuang" id="introduce"><%=introduce%></textarea></td>
    </tr>
    <tr>
