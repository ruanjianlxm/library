...
<link href="CSS/style.css" rel="stylesheet">
		...
		function checkreader(form){
			if(form.barcode.value==""){
				alert("请输入读者编码!");form.barcode.focus();return;
			}
			form.submit();
		}
                  ...
                  <tr>
                    <td><table width="90%" height="21" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td width="76%" style="padding-top:7px;">读者条码：
...
<input name="inputkey" type="text" id="inputkey" size="50">
  ...
  <input name="Button" type="button" class="btn_grey" value="下一位" onClick="window.location.href='bookBorrow.jsp'">
                   </td>
               </tr> 
          <tr>
            <td valign="top" bgcolor="c0ffff" style="padding:5px"><table width="99%" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#F6B83B" bgcolor="#FFFFFF">
                   <tr align="center" bgcolor="c0ffff">
